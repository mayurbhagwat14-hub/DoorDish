    ...
    <div className="min-h-[100dvh] bg-white dark:bg-[#0a0a0a] flex flex-col relative overflow-hidden font-['Poppins']">
      ...
      <div className="absolute top-0 left-0 w-full h-[40vh] pointer-events-none z-0 transform scale-[1.05] origin-center">
        <svg viewBox="0 0 1440 320" className="w-full h-full block" preserveAspectRatio="none" overflow="visible">
          <defs>
            <linearGradient id="topOrangeGrad" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      <div className="absolute bottom-0 left-0 w-full h-[50vh] pointer-events-none z-0 transform scale-[1.05] origin-center">
        <svg viewBox="0 0 1440 320" className="w-full h-full block" preserveAspectRatio="none" overflow="visible">
          <defs>
            <linearGradient id="botOrangeGrad" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#FA5300" />
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 pb-24 relative z-10 overflow-y-auto">
        <div className="w-full max-w-sm flex flex-col relative -top-10 my-auto">
          ...
          <div className="mb-5 text-center flex flex-col items-center">
            ...
            <h2 className="text-[25px] font-extrabold text-[#FA5300] dark:text-[#FF6B1A] tracking-tight font-['Outfit'] pb-0.5">
              Delivery Partner
            </h2>
                        ...
                        <div className="flex flex-col gap-3 pt-2">
                          {isRejected && (
                            <button
                              ...
                              className="w-full py-3.5 bg-gradient-to-r from-[#FA5300] to-[#FF5800] hover:from-[#E54B00] hover:to-[#FA5300] text-white rounded-full font-semibold text-base shadow-[0_8px_20px_rgba(250,83,0,0.2)] transition-all active:scale-[0.98]"
                            >
                              Re-apply Now
                            </button>
                          )}
                          ...
                          <button
                            type="button"
                            onClick={handleBackToLogin}
                            className="w-full py-3.5 bg-gradient-to-r from-[#FA5300] to-[#FF5800] hover:from-[#E54B00] hover:to-[#FA5300] text-white rounded-full font-medium text-base shadow-[0_8px_20px_rgba(250,83,0,0.3)] transition-all active:scale-[0.98] flex items-center justify-center"
                          >
                            Back to login
                          </button>
                        </div>
                      ...
                      <div className="space-y-6">
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            className={`block w-full px-6 py-3.5 bg-gray-50 dark:bg-gray-800 border-2 shadow-sm text-gray-900 dark:text-white rounded-full outline-none transition-all duration-300 placeholder:text-gray-400 font-medium text-base focus:bg-white dark:focus:bg-gray-900 focus:border-[#FA5300] focus:ring-4 focus:ring-[#FA5300]/10 ${nameError ? "border-red-500" : "border-gray-300 dark:border-gray-600"}`}
                          />
                          {nameError && (
                        ...
                        <button
                          ...
                          className="w-full py-3.5 bg-gradient-to-r from-[#FA5300] to-[#E54B00] hover:from-[#1157b5] hover:to-[#041630] disabled:opacity-50 text-white rounded-full font-medium text-base shadow-[0_8px_20px_rgba(14,75,156,0.3)] disabled:shadow-none transition-all active:scale-[0.98] flex items-center justify-center gap-2 mt-4"
                        >
                          {loading ? (
                            <span className="flex items-center gap-2">
                              <Loader2 className="w-5 h-5 animate-spin" />
