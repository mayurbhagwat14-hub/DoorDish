      ...
      <div className="max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-5xl mx-auto space-y-4 md:space-y-5 lg:space-y-6">
            ...
            <CardHeader className="p-4 md:p-5 lg:p-6">
              <div className="flex items-center justify-between">
                <CardTitle className="flex items-center gap-2 text-lg md:text-xl lg:text-2xl">
                  <Package className="h-4 w-4 md:h-5 md:w-5 text-[#FF5A1F]" />
                  Order Summary
                </CardTitle>
            ...
            <CardContent className="space-y-4 md:space-y-5 p-4 md:p-5 lg:p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
                ...
                <div>
                  ...
                  <p className="font-semibold text-[#FF5A1F] text-xl">${order.total.toFixed(2)}</p>
                </div>
                <div>
                    ...
                    <CardHeader className="p-4 md:p-5 lg:p-6">
                      <div className="flex items-start gap-3 md:gap-4">
                        <div className="p-2 md:p-3 bg-yellow-100 rounded-lg">
                          <Icon className="h-4 w-4 md:h-5 md:w-5 text-[#FF5A1F]" />
                        </div>
                      ...
                      <div className="flex gap-2 pt-2 border-t">
                        {issue.actions.map((action, idx) => (
                          <Button
                            ...
                            size="sm"
                            className={idx === 0 ? "bg-[#FF5A1F] hover:opacity-90" : ""}
        ...
        <ScrollReveal delay={0.3}>
          <Card className="bg-gradient-to-br from-yellow-50 to-orange-50 border-yellow-200 shadow-lg">
            <CardHeader className="p-4 md:p-5 lg:p-6">
              <CardTitle className="flex items-center gap-2 text-lg md:text-xl lg:text-2xl">
                <HelpCircle className="h-4 w-4 md:h-5 md:w-5 text-[#FF5A1F]" />
                Quick Actions
              </CardTitle>
            </CardHeader>
          ...
          <Card id="contact-support" className="shadow-lg">
            <CardHeader className="p-4 md:p-5 lg:p-6">
              <CardTitle className="text-xl md:text-2xl lg:text-3xl flex items-center gap-2">
                <MessageCircle className="h-5 w-5 md:h-6 md:w-6 text-[#FF5A1F]" />
            ...
            <CardContent className="space-y-4 md:space-y-5 lg:space-y-6 p-4 md:p-5 lg:p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 lg:gap-6">
                <div className="flex items-start gap-3 p-4 bg-muted/50 rounded-lg">
                  <div className="p-2 bg-orange-100 rounded-lg">
                    <Phone className="h-5 w-5 text-[#FF5A1F]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-3 p-4 bg-muted/50 rounded-lg">
                  ...
                  <div>
                    ...
                    <a
                      href={`mailto:support@doordish.com?subject=Help with Order ${order.id}`}
                      className="text-sm text-primary hover:underline font-medium"
                    >
                      support@doordish.com
                    </a>
                  </div>
                </div>
              </div>
              <div className="pt-4 border-t">
                <Button
                  className="w-full bg-[#FF5A1F] hover:opacity-90"
