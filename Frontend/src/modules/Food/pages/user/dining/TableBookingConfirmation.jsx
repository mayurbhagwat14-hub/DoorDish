  ...
  const goBack = useAppBackNavigation()
    ...
    return (
        <AnimatedPage className="bg-slate-50 dark:bg-slate-950 min-h-screen pb-24 transition-colors">
            {/* Header */}
            <div className="bg-[#FF5A1F] text-white px-4 py-4 sticky top-0 z-50 shadow-md">
            ...
            <div className="p-4 space-y-4">
                ...
                >
                    <div className="flex items-center gap-3">
                        <div className={`p-2 rounded-xl transition-colors ${specialRequest ? 'bg-purple-50 dark:bg-purple-950/30' : 'bg-slate-100 dark:bg-slate-800 group-hover:bg-slate-200 dark:group-hover:bg-slate-700'}`}>
                            <Info className={`w-5 h-5 ${specialRequest ? 'text-[#FF5A1F]' : 'text-slate-600 dark:text-slate-400'}`} />
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                        {specialRequest && (
                            <span className="text-[10px] font-black text-[#FF5A1F]/40 uppercase tracking-widest">Edit</span>
                        )}
                ...
                <div className="pt-4">
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            <div className="flex items-start gap-3">
                                <div className="text-[#FF5A1F] dark:text-purple-400 mt-1">
            ...
            <div className="fixed bottom-0 left-0 w-full bg-white dark:bg-[#0d0d0d] border-t border-slate-100 dark:border-white/5 p-4 pb-[max(1rem,env(safe-area-inset-bottom))] z-50">
                <Button
                    ...
                    className="w-full h-14 bg-[#FF5A1F] hover:bg-[#E64A0F] text-white font-bold text-lg rounded-2xl transition-all active:scale-[0.98] disabled:opacity-60"
                >
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3 pt-1">
                                ...
                                <button
                                    ...
                                    className="h-12 rounded-xl bg-[#FF5A1F] text-white font-bold text-sm uppercase tracking-widest shadow-lg shadow-red-200 dark:shadow-none active:scale-95 transition-all"
                                >
                                    Save
                                </button>
                            </div>
