        ...
        <AnimatedPage className="min-h-screen bg-[#f8f9fa] pb-20">
            ...
            <div className="max-w-lg mx-auto px-4 py-8 space-y-6">
                ...
                <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100 text-center space-y-4">
                    <div className="w-20 h-20 bg-[#FF5A1F]/10 text-[#FF5A1F] rounded-full flex items-center justify-center mx-auto mb-2 animate-pulse">
                ...
                {/* Info Box */}
                <div className="bg-[#FF5A1F] rounded-3xl p-6 text-white shadow-xl shadow-[#FF5A1F]/20">
                ...
                <div className="pt-6 space-y-4">
                    <button 
                        ...
                        className="w-full h-14 bg-[#FF5A1F] text-white rounded-2xl font-black uppercase tracking-widest text-sm shadow-xl shadow-[#FF5A1F]/20 active:scale-95 transition-all"
                    >
                        Modify Details Now
                    </button>
                    <button 
