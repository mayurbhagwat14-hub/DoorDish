...
const TrackingPage = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gray-900 font-sans overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 z-20 bg-[#FF5A1F] p-4 pt-4 rounded-b-2xl shadow-lg">
        ...
        <div className="text-center text-white">
          ...
          <div className="flex items-center justify-center gap-2 bg-[#E64A0F] w-fit mx-auto px-4 py-2 rounded-full">
      ...
      <div className="absolute top-0 left-0 w-full h-full z-0">
        ...
        <div className="absolute bottom-[50vh] left-4 right-4 z-10 bg-white dark:bg-[#1a1a1a] rounded-xl p-4 shadow-lg border border-gray-200 dark:border-gray-800">
          ...
          <div className="w-full h-2 bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden">
            <div className="h-full bg-[#FF5A1F] rounded-full" style={{ width: '60%' }}></div>
          </div>
        </div>
      </div>
