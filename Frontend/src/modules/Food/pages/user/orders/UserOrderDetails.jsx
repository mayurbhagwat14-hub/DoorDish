      ...
      <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg bg-[#FF5A1F] text-white text-sm font-semibold hover:bg-[#E64A0F] transition-all active:scale-95 shadow-md"
          >
            Back to Orders
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] pb-24 font-sans relative">
      ...
      <div className="p-4 space-y-4">
        ...
        {order && order.status === "delivered" && (
          <button
            ...
            className="w-full bg-[#FF5A1F]/5 border border-[#FF5A1F]/20 text-[#FF5A1F] py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-[#FF5A1F]/10 transition-colors"
          >
        ...
        <div className="bg-white dark:bg-[#121212] rounded-xl shadow-sm overflow-hidden border dark:border-gray-800">
          <div className="p-4 flex justify-between items-center border-b border-gray-100 dark:border-gray-800">
            ...
            <button
              ...
              className="w-7 h-7 rounded-full bg-[#FF5A1F]/10 flex items-center justify-center text-[#FF5A1F] hover:bg-[#FF5A1F]/20 transition-colors"
            >
            ...
            {order.orderType !== "takeaway" && order.orderType !== "dining" && (
              <div className="flex justify-between">
                ...
                {pricing.deliveryFee === 0 && (
                  <span className="text-[#FF5A1F] text-[10px] font-bold border border-[#FF5A1F] px-1 rounded ml-1">
                    FREE
                  </span>
                )}
                <span className="text-[#FF5A1F] dark:text-[#a04882] font-medium uppercase">
          ...
          {/* Savings Banner */}
          {savings > 0 && (
            <div className="relative bg-[#FF5A1F]/5 p-3 pb-4 mt-2">
              ...
              <div className="flex items-center justify-center gap-2 pt-1 text-[#FF5A1F] font-bold text-sm">
                <span></span>
                <span>
      ...
      <div className="fixed bottom-0 w-full bg-white dark:bg-[#121212] border-t border-gray-200 dark:border-gray-800 p-4 flex gap-3 z-20">
        <button
          ...
          className="flex-1 bg-[#FF5A1F] text-white py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-[#E64A0F] transition-all active:scale-95 shadow-md"
        >
        ...
        <button
          type="button"
          onClick={handleDownloadSummary}
          className="flex-1 bg-white dark:bg-[#1a1a1a] border border-[#FF5A1F] text-[#FF5A1F] py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-[#FF5A1F]/5 transition-colors"
        >
          <Download className="w-4 h-4" />
          Invoice
        </button>
