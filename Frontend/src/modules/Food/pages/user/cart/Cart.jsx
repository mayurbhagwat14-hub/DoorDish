...
export default function Cart() {
  ...
  const renderCartCouponCard = (coupon, { compact = false, blocked = false } = {}) => {
    ...
    return (
      <div
        key={coupon.code}
        className={`bg-[#FF5A1F]/5 dark:bg-[#FF5A1F]/10 border border-[#FF5A1F]/10 dark:border-[#FF5A1F]/20 rounded-xl flex items-center justify-between gap-3 ${
      ...
      >
        <div className="flex items-center gap-2.5 min-w-0">
          <div className="w-8 h-8 rounded-full bg-red-100 dark:bg-[#FF5A1F]/20 flex items-center justify-center flex-shrink-0">
            <Percent className="w-4 h-4 text-[#FF5A1F]" />
          </div>
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="inline-block text-[10px] font-bold text-[#FF5A1F] uppercase tracking-wider bg-white dark:bg-gray-900 border border-dashed border-[#FF5A1F]/30 px-2 py-0.5 rounded shadow-sm">
                {coupon.code}
              </span>
        ...
        <button
          ...
          className={`text-xs font-black px-4 py-1.5 rounded-lg shadow-sm active:scale-95 transition-all flex-shrink-0 uppercase tracking-wider ${
            isApplicable
              ? "text-[#FF5A1F] bg-white dark:bg-gray-900 border border-[#FF5A1F]/20 hover:bg-[#FF5A1F]/5"
    ...
    return (
      <AnimatedPage className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a]">
        ...
        <div className="flex flex-col items-center justify-center py-20 px-4">
          ...
          <Link to="/user">
            <Button className="bg-[#FF5A1F] hover:bg-[#E64A0F] text-white">Browse Restaurants</Button>
          </Link>
        </div>
      </AnimatedPage>
    )
                ...
                <div className="bg-white dark:bg-[#1a1a1a] px-4 md:px-6 py-3 md:py-4 rounded-lg md:rounded-xl border border-slate-100 dark:border-gray-800">
                  ...
                  <textarea
                    ...
                    placeholder="Eg. Don't add onions, make it extra spicy, etc."
                     className="w-full border border-gray-200 dark:border-gray-700 rounded-lg md:rounded-xl p-3 md:p-4 text-sm md:text-base resize-none h-20 md:h-24 focus:outline-none focus:border-[#FF5A1F] dark:focus:border-[#FF5A1F] bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-gray-100"
                    maxLength={240}
                  />
                ...
                <div className="bg-white dark:bg-[#1a1a1a] px-4 md:px-6 py-5 rounded-2xl shadow-sm border border-slate-100 dark:border-gray-800">
                  <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                    <div className="w-6 h-6 md:w-8 md:h-8 bg-gray-100 dark:bg-gray-800 rounded flex items-center justify-center">
                       <Sparkles className="h-4 w-4 md:h-5 md:w-5 text-[#FF5A1F]" />
                    </div>
                          ...
                          <div className="relative bg-gray-100 dark:bg-gray-800 rounded-lg md:rounded-xl overflow-hidden">
                            ...
                            <button
                              onClick={() => {
                               ...
                               className="absolute bottom-1 md:bottom-2 right-1 md:right-2 w-6 h-6 md:w-7 md:h-7 bg-white border border-[#FF5A1F] rounded flex items-center justify-center shadow-sm hover:bg-[#FF5A1F05] dark:hover:bg-[#FF5A1F10] transition-colors"
                            >
                               <Plus className="h-3.5 w-3.5 md:h-4 md:w-4 text-[#FF5A1F]" />
                            </button>
                          </div>
                    ...
                    {filteredCoupons.length > 0 ? (
                      <div className="space-y-2.5">
                        ...
                        <button
                          ...
                          className={`w-full py-2.5 px-4 bg-gray-50/50 hover:bg-gray-50 dark:bg-gray-900/30 dark:hover:bg-gray-900/50 border border-dashed border-gray-200 dark:border-gray-800 rounded-xl text-xs font-bold text-[#FF5A1F] flex items-center justify-between transition-all active:scale-[0.98] mt-2.5 ${
                      ...
                      <button
                        ...
                        className={`w-full py-2.5 px-4 bg-gray-50/50 hover:bg-gray-50 dark:bg-gray-900/30 dark:hover:bg-gray-900/50 border border-dashed border-gray-200 dark:border-gray-800 rounded-xl text-xs font-bold text-[#FF5A1F] flex items-center justify-between transition-all active:scale-[0.98] ${
                    ...
                    <div className="mt-5 flex flex-col sm:flex-row gap-3 pt-3 border-t border-gray-100 dark:border-gray-800">
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          className="w-full text-sm p-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-[#0a0a0a] text-gray-800 dark:text-gray-200 focus:outline-none focus:border-[#FF5A1F]"
                        />
                      </div>
                      <div className="flex-1">
                          ...
                          <div className="relative">
                            <select
                              ...
                              onChange={(e) => setScheduledTime(e.target.value)}
                               className="w-full text-sm p-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-[#0a0a0a] text-gray-800 dark:text-gray-200 focus:outline-none focus:border-[#FF5A1F] appearance-none pr-8"
                            >
              ...
              <div className="bg-white dark:bg-[#1a1a1a] px-4 md:px-6 py-5 rounded-2xl shadow-sm border border-slate-100 dark:border-gray-800">
                {orderType === "takeaway" ? (
                  <div className="flex items-start gap-4">
                    <div className="bg-[#FF5A1F05] dark:bg-[#FF5A1F10] p-3.5 rounded-2xl border border-[#FF5A1F15] dark:border-[#FF5A1F30]">
                  ...
                  <div className="flex items-start justify-between w-full text-left">
                    <div className="flex items-start gap-4 flex-1">
                       <div className="bg-[#FF5A1F05] dark:bg-[#FF5A1F10] p-2 rounded-xl mt-0.5">
                         <MapPin className="h-5 w-5 text-[#FF5A1F]" />
                       </div>
                      <div className="flex-1">
                            ...
                            {deliveryAddressMode === "current" ? (
                              <div className="mt-1">
                                ...
                                <div className="mt-1 flex items-center gap-2">
                                   <span className="inline-flex items-center rounded-full px-2 py-0.5 text-[10px] md:text-[11px] font-semibold bg-[#FF5A1F05] text-[#FF5A1F] dark:bg-[#FF5A1F10] dark:text-[#FF5A1F] border border-[#FF5A1F]/30">
                                     GPS enabled
                                   </span>
                                </div>
                              </div>
                          ...
                          {!hasSavedAddress && (
                             <p className="text-sm text-[#FF5A1F] mt-2 font-medium">
                                ...
                                return (
                                  <button
                                    ...
                                    onClick={(e) => {
                                     ...
                                     className={`w-full text-left rounded-xl border-2 p-3 transition-colors ${isSelected
                                       ? "border-[#FF5A1F] bg-[#FF5A1F05] dark:bg-[#FF5A1F]/5"
                                  ...
                                  >
                                    <div className="flex items-start justify-between gap-3">
                                      ...
                                      {isSelected && (
                                         <span className="text-[10px] bg-[#FF5A1F] text-white px-2 py-0.5 rounded uppercase font-bold tracking-wider whitespace-nowrap">
                                           Selected
                                         </span>
                                      )}
                                    </div>
                    ...
                    <button
                      type="button"
                       onClick={openLocationSelector}
                       className="p-2 text-[#FF5A1F] bg-[#FF5A1F05] rounded-full hover:bg-[#FF5A1F10] transition-colors dark:bg-[#FF5A1F15] dark:hover:bg-[#FF5A1F20]"
                ...
                <div className="flex items-start justify-between gap-3">
                  ...
                  <button
                    ...
                    onClick={() => setIsEditingRecipient((prev) => !prev)}
                     className="text-[#FF5A1F] text-xs md:text-sm font-semibold whitespace-nowrap"
                  >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Enter recipient name"
                         className="w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#111111] px-3 py-2.5 text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:border-[#FF5A1F]"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">
...
{/* Bill Details */}
              <div className="bg-white dark:bg-[#1a1a1a] px-4 md:px-6 py-5 rounded-2xl shadow-sm border border-slate-100 dark:border-gray-800">
                ...
                >
                  <div className="flex items-center gap-3">
                    <FileText className="h-5 w-5 text-gray-700 dark:text-gray-300 group-hover:text-[#FF5A1F] transition-colors" />
                    <span className="text-base text-gray-900 dark:text-gray-100 font-black tracking-tight group-hover:text-[#FF5A1F] transition-colors">Bill Details</span>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div className="w-7 h-7 rounded-full bg-slate-50 dark:bg-gray-800 group-hover:bg-[#FF5A1F]/5 flex items-center justify-center transition-all border border-slate-100 dark:border-gray-700 group-hover:border-[#FF5A1F]/20">
                      <ChevronRight className={`h-4 w-4 text-gray-500 group-hover:text-[#FF5A1F] transition-transform duration-300 ${showBillDetails ? 'rotate-90' : 'rotate-0'}`} />
                    </div>
                  </div>
                </button>
                ...
                {showBillDetails && (
                  <div className="mt-4 pt-4 border-t border-dashed border-gray-200 dark:border-gray-800 space-y-3">
                      ...
                      <>
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600 dark:text-gray-400">Delivery Fee</span>
                           <span className={deliveryFee === 0 ? "text-[#FF5A1F] font-medium" : "text-gray-800 dark:text-gray-200 font-medium"}>
                             {loadingPricing ? (
                               <span className="inline-block h-4 w-12 rounded bg-gray-200 dark:bg-gray-700 animate-pulse align-middle" />
                             ) : (
                        ...
                        {Number((pricing?.freeDeliveryUpTo ?? feeSettings.freeDeliveryUpTo) || 0) > 0 && (
                          <div className="-mt-1.5">
                            <div className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-[#FF5A1F]/10 via-[#FF5A1F]/20 to-[#FF5A1F]/10 text-[#FF5A1F] border border-[#FF5A1F]/25 px-2.5 py-1 text-[11px] font-semibold shadow-sm">
                              <Sparkles className="h-3 w-3" />
                              <span>Free delivery at</span>
                              <span className="text-[#E64A0F]">
                    ...
                    {discount > 0 && (
                       <div className="flex justify-between text-sm text-[#FF5A1F] font-medium">
                         <span>Coupon Discount</span>
                         <span>
                           {loadingPricing ? (
                             <span className="inline-block h-4 w-12 rounded bg-[#FF5A1F]/20 animate-pulse align-middle" />
                           ) : (
      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4">
          <div className="w-full max-w-lg mx-auto space-y-3">
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-[#FF5A1F10] dark:bg-[#FF5A1F20] flex items-center justify-center flex-shrink-0">
                   {selectedPaymentMethod === "wallet" ? (
                    <Wallet className="h-5 w-5 text-[#FF5A1F]" />
                  ) : selectedPaymentMethod === "razorpay" ? (
                    <Zap className="h-5 w-5 text-[#FF5A1F]" />
                  ) : (
                    <Banknote className="h-5 w-5 text-[#FF5A1F]" />
                  )}
                </div>
               ...
               <div className="flex items-center gap-0.5 text-[#FF5A1F] font-bold text-[11px] uppercase tracking-widest bg-[#FF5A1F05] dark:bg-[#FF5A1F10] px-2.5 py-1 rounded-lg">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-[#FF5A1F] to-[#E64A0F] hover:from-[#E64A0F] hover:to-[#7F1D1D] text-white px-6 h-12 md:h-14 rounded-2xl font-black shadow-lg shadow-[#FF5A1F]/30 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-between transition-all active:scale-[0.98] border-b-4 border-red-900/30"
            >
                ...
                <div className="px-6 py-8">
                  ...
                  <div className="relative mb-6">
                    <div className="h-2.5 bg-gray-200 rounded-full overflow-hidden">
                      <div
                         className="h-full bg-gradient-to-r from-[#FF5A1F] to-[#E64A0F] rounded-full transition-all duration-100 ease-linear"
                        style={{
                           width: `${orderProgress}%`,
                  ...
                  >
                    <span className="text-[#FF5A1F] font-semibold text-base hover:text-[#E64A0F] transition-colors">
                      CANCEL
                    </span>
                  </button>
                </div>
          ...
          {showOrderSuccess && (
            ...
            >
                ...
                {[...Array(50)].map((_, i) => (
                  <div
                    ...
                    style={{
                      ...
                      top: `-10%`,
                      backgroundColor: ['#FF5A1F', '#3b82f6', '#f59e0b', '#ef4444', '#E64A0F', '#ec4899'][Math.floor(Math.random() * 6)],
              ...
              <div className="relative z-10 flex flex-col items-center px-6">
                ...
                >
                  <h3 className="text-3xl font-bold text-[#FF5A1F] dark:text-[#a65d8a] mb-2">Order Placed!</h3>
                ...
                {/* Action Button */}
                 <button
                  ...
                  className="mt-10 bg-[#FF5A1F] hover:bg-[#E64A0F] text-white font-semibold py-4 px-12 rounded-xl shadow-lg shadow-[#FF5A1F]/20 dark:shadow-[#FF5A1F]/40 transition-all hover:shadow-xl hover:scale-105"
                  ...
                  <div className="p-5 md:p-6 flex flex-col h-full min-h-0">
                    ...
                    <div className="space-y-3 overflow-y-auto pr-1 custom-scrollbar pb-4 flex-1 min-h-0">
                      {[
                        ...
                        },
                        {
                          ...
                          color: 'bg-orange-50 text-#E64A0F dark:bg-orange-900/40 dark:text-orange-400',
                          selectedColor: 'bg-[#FF5A1F] text-white',
                        ...
                        <button
                          ...
                          onClick={() => {
                           ...
                           className={`w-full flex items-center justify-between p-4 rounded-2xl border-2 transition-all duration-300 group ${selectedPaymentMethod === option.id
                               ? 'border-[#FF5A1F] bg-[#FF5A1F] shadow-lg shadow-[#FF5A1F]/30'
                               : 'border-gray-100 dark:border-gray-800/80 bg-white dark:bg-[#222222] hover:border-[#FF5A1F]/30 dark:hover:border-[#FF5A1F]/30 shadow-sm'
                        ...
                        >
                          ...
                          <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all duration-300 ${selectedPaymentMethod === option.id
                             ...
                             {selectedPaymentMethod === option.id && <Check className="w-3.5 h-3.5 text-[#FF5A1F]" strokeWidth={4} />}
                           </div>
                        </button>
                      ))}
                    </div>
                    ...
                    >
                      <div className="flex-shrink-0">
                         ...
                         <p className="text-xl font-black text-[#FF5A1F] tabular-nums">{RUPEE_SYMBOL}{total.toFixed(0)}</p>
                       </div>
                       <Button
                        onClick={() => setShowPaymentSheet(false)}
                        className="flex-1 bg-[#FF5A1F] hover:bg-[#E64A0F] text-white h-11 rounded-xl text-sm font-bold shadow-lg shadow-[#FF5A1F]/20 transition-all active:scale-[0.98]"
                      >
                        Confirm Order
                      </Button>
                    </div>
                ...
                <div className="fixed inset-0 flex items-end justify-center z-[10021] pointer-events-none p-0">
                  ...
                  >
                    ...
                    <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50/60 dark:bg-gray-900/30">
                      <div className="flex items-center gap-3">
                        <div className="flex-1 bg-white dark:bg-gray-950 rounded-xl px-4 h-11 border border-gray-200 dark:border-gray-800 flex items-center focus-within:border-[#FF5A1F] focus-within:ring-1 focus-within:ring-[#FF5A1F]/20 transition-all">
                          <input
                            type="text"
                        ...
                        <button
                          ...
                          className="h-11 px-5 border border-[#FF5A1F] text-[#FF5A1F] rounded-xl text-xs font-black uppercase tracking-widest hover:bg-[#FF5A1F05] active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          Apply
                        </button>
                      </div>
                ...
                <div className="fixed inset-0 flex items-end sm:items-center justify-center z-[10021] pointer-events-none sm:p-4">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full mt-6 h-12 bg-[#FF5A1F] hover:bg-[#E64A0F] text-white rounded-xl text-sm font-bold uppercase tracking-widest active:scale-95 transition-all shadow-md shadow-[#FF5A1F]/20 relative z-10 cursor-pointer"
                    >
                      APPLY
                    </button>
                  </motion.div>
              ...
              >
                <div className="flex flex-col items-center gap-4 text-center px-6">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 w-16 h-16 rounded-full border-4 border-t-[#FF5A1F] dark:border-t-red-500 animate-spin" />
                  </div>
