          ...
          <div className="mb-6">
            <div className="relative max-w-3xl mx-auto">
              <Input
                ...
                className="w-full h-12 sm:h-14 md:h-16 pl-12 sm:pl-14 pr-12 sm:pr-14 rounded-xl border-2 border-gray-200 focus:border-[#FF5A1F] bg-white shadow-sm text-base sm:text-lg md:text-xl"
              />
                  ...
                  return (
                    <Button
                      ...
                      className={`h-7 sm:h-8 px-2 sm:px-3 rounded-full flex items-center gap-1.5 whitespace-nowrap flex-shrink-0 transition-all font-medium ${isActive
                        ? 'bg-[#FF5A1F] text-white border-[#FF5A1F] hover:bg-[#E64A0F]'
                      ...
                      <CardContent className="p-3 sm:p-4 pt-3 sm:pt-4">
                        ...
                        {restaurant.offer && (
                          <div className="flex items-center gap-2 text-sm">
                            <BadgePercent className="h-4 w-4 text-[#FF5A1F]" strokeWidth={2} />
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center gap-1 py-4 px-2 text-center relative transition-colors ${isActive ? 'bg-white text-[#FF5A1F]' : 'text-gray-500 hover:bg-gray-100'
                        }`}
                    >
                      {isActive && (
