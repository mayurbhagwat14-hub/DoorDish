    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <div className="px-4 py-4 bg-white">
        ...
        <button
          ...
          className="flex items-center gap-1 text-[#FA5300] text-sm font-normal hover:text-blue-700 transition-colors"
        >
        ...
        <div className="px-4 py-6 pb-8">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 border-2 border-[#FA5300] bg-white rounded-lg py-3 px-4 hover:bg-blue-50 transition-colors"
            >
              <ThumbsUp className="w-5 h-5 text-[#FA5300]" />
              <span className="text-[#FA5300] text-sm font-semibold">Yes, thank you</span>
            </button>
            <button
      ...
      >
        <div className="text-center py-6">
          ...
          <button
            ...
            className="w-full bg-gradient-to-br from-[#FA5300] to-[#E54B00] text-white py-3 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors"
          >
            Contact Support
          </button>
        </div>
