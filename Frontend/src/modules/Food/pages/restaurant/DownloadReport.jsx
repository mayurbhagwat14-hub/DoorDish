  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
          ...
          <div className="grid grid-cols-3 border border-gray-300 rounded-xl overflow-hidden text-center text-sm font-semibold">
            {VIEW_TYPES.map((type) => (
              <button
                ...
                className={`py-2 ${viewType === type ? "bg-gradient-to-br from-[#FA5300] to-[#E54B00] text-white" : "bg-white text-gray-800"}`}
              >
                {type}
              </button>
            ))}
      ...
      <div className="px-4 pb-6">
        <button
          onClick={handleSend}
          className="w-full bg-gradient-to-br from-[#FA5300] to-[#E54B00] text-white py-4 rounded-xl text-sm font-semibold flex items-center justify-center gap-2"
        >
