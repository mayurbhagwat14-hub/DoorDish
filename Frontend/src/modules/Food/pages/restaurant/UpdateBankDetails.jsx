...
export default function UpdateBankDetails() {
  ...
  const inputClass = (key) =>
    `w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 text-base transition-colors ${
      errors[key]
        ? "border-red-500 focus:ring-[#FA5300] focus:border-[#FA5300]"
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              {errors.accountHolderName ? (
                <p className="mt-1.5 text-xs text-[#FA5300] flex items-center gap-1">
            ...
            <button
              ...
              className="w-full bg-gradient-to-br from-[#FA5300] to-[#E54B00] hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed text-white font-bold py-4 rounded-lg text-base transition-colors"
            >
