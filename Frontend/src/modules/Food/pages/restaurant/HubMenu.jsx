    ...
    <div className="h-screen bg-gray-50 flex flex-col overflow-hidden">
        ...
        <div className="">
          ...
          <div className="flex px-4 relative items-center gap-2 overflow-x-auto pb-2 scrollbar-hide" ref={scrollContainerRef} style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            ...
            <button
              ...
              className="z-10 shrink-0 bg-gradient-to-br from-[#FA5300] to-[#E54B00] text-white border-2 border-black flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium whitespace-nowrap"
            >
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        ...
                        {isRejectedApproval(addon.approvalStatus) && addon.rejectionReason && (
                          <p className="text-xs text-[#FA5300] mt-1">Reason: {addon.rejectionReason}</p>
                        )}
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex flex-col gap-2">
                          <button
                            ...
                            className="p-2 bg-blue-100 text-[#FA5300] rounded-lg hover:bg-blue-200 transition-colors"
                            title="Edit add-on"
                          >
                          ...
                          <button
                            ...
                            className="p-2 bg-red-100 text-[#FA5300] rounded-lg hover:bg-red-200 transition-colors"
                            title="Delete add-on"
                          >
            ...
            return (
              ...
              <div className="py-3 flex items-center justify-between px-4">
                <div className="flex items-center gap-3 flex-1">
                  <div className="w-1 h-6 bg-gradient-to-br from-[#FA5300] to-[#E54B00] rounded-r-full" />
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              >
                                <div className={`w-2 h-2 rounded-full ${
                                  item.foodType === "Veg"
                                    ? "bg-green-600"
                                    : "bg-gradient-to-br from-[#FA5300] to-[#E54B00]"
                                }`} />
                              </div>
                            </div>
                            ...
                            {isRejectedApproval(item.approvalStatus) && item.rejectionReason && (
                              <p className="text-xs text-[#FA5300] -mt-2 mb-3">Reason: {item.rejectionReason}</p>
                            )}
                          </div>
          ...
          <>
            ...
            >
              ...
              <div className="px-4 py-4 border-t border-gray-200 space-y-2">
                ...
                <button
                  onClick={() => setIsFilterOpen(false)}
                  className="w-full py-3 rounded-lg font-semibold text-sm bg-gradient-to-br from-[#FA5300] to-[#E54B00] text-white hover:bg-gray-800 transition-colors"
                >
                  Confirm
                </button>
              </div>
      ...
      <div className="fixed right-4 bottom-24 z-30 flex flex-col gap-1">
        ...
        {activeTab !== "add-ons" && (
          ...
          className="px-4 py-2 border bg-gradient-to-br from-[#FA5300] to-[#E54B00] text-white border-gray-800 rounded-lg text-sm font-bold"
        >
          + ADD
        </motion.button>)}
              ...
              <div className="flex-1 overflow-y-auto px-4 py-4">
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left text-sm font-medium text-[#FA5300] bg-gray-50 hover:bg-red-50 transition-colors"
                  >
                    <Trash2 className="w-5 h-5 text-[#FA5300]" />
                            ...
                            {group.items.map((item) => (
                              ...
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  {isRejectedApproval(item.approvalStatus) && item.rejectionReason && (
                                    <p className="text-xs text-[#FA5300] mt-1">Reason: {item.rejectionReason}</p>
                                  )}
                                  {!item.isAvailable && (
                                    <span className="text-xs text-[#FA5300] font-medium">Out of stock</span>
                                  )}
                                </div>
                              </div>
                            ))}
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Add-on Name <span className="text-[#FA5300]">*</span>
                  </label>
                  <input
                    type="text"
                    value={addonName}
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Price (₹) <span className="text-[#FA5300]">*</span>
                  </label>
                  <input
                    type="number"
                    value={addonPrice}
                      ...
                      {addonImages.map((img, index) => (
                        <div key={index} className="relative group">
                          ...
                          <button
                            ...
                            className="absolute top-1 right-1 p-1 bg-gradient-to-br from-[#FA5300] to-[#E54B00] text-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
                          >
                            <X className="h-4 w-4" />
                          </button>
                        </div>
