    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 px-4 pt-4 pb-28 space-y-4">
        <div className="rounded-2xl bg-[#ffe9b3] px-4 py-3 flex items-start gap-3">
          <div className="mt-1 h-6 w-6 rounded-full bg-gradient-to-br from-[#FA5300] to-[#E54B00]/80 flex items-center justify-center text-white text-xs font-semibold">
            i
          </div>
          <div className="flex-1">
      ...
      <div className="px-4 pb-6 pt-3 border-t border-gray-200 bg-white">
        <button
          type="button"
          className="w-full py-3 rounded-full bg-gradient-to-br from-[#FA5300] to-[#E54B00] text-white text-sm font-medium mb-2"
        ...
        <p className="text-xs text-center text-gray-600">
          ...
          <button
            type="button"
            className="text-[#FA5300] underline underline-offset-2"
            onClick={() => navigate("/food/restaurant/fssai/update")}
          >
            Apply Now
          </button>
