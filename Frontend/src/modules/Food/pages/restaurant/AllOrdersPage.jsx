...
const filterOptions = {
  ...
  "Order type": [
    ...
    // Dining filter hidden while DINING_ENABLED is false
...
export default function AllOrdersPage() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case "READY":
        return "bg-gradient-to-br from-[#FA5300] to-[#E54B00] text-white"
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="px-4 py-4 space-y-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            aria-label="Filter"
          >
            <Filter className={`w-5 h-5 ${hasActiveFilters() ? 'text-[#FA5300]' : 'text-gray-900'}`} />
            {hasActiveFilters() && (
              <span className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-br from-[#FA5300] to-[#E54B00] rounded-full text-white text-xs flex items-center justify-center font-bold">
      ...
      {hasActiveFilters() && (
        <div className="px-4 pb-2">
          ...
          >
            <div className="flex items-center gap-2">
              <Filter className="w-4 h-4 text-[#FA5300]" />
            ...
            <button
              ...
              className="text-xs text-[#FA5300] hover:text-blue-800 font-medium hover:underline"
            >
              Clear all
            </button>
          </motion.div>
      ...
      <div className="px-4 pb-24 space-y-3">
        {loading && (
          <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
            <div className="flex flex-col items-center gap-3">
              <div className="w-8 h-8 border-4 border-[#FA5300] border-t-transparent rounded-full animate-spin"></div>
        ...
        {!loading && error && (
          <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
            <div className="flex flex-col items-center gap-3">
              <p className="text-[#FA5300] font-medium text-sm">Error loading orders</p>
          ...
          <AnimatePresence mode="popLayout">
            ...
            <div className="space-y-2">
              ...
              {order.items.length > 2 && (
                <p className="text-xs text-[#FA5300] font-medium">+{order.items.length - 2} more items</p>
              )}
            </div>
            ...
            {order.reason && (
              <div className="mt-3 pt-3 border-t border-gray-200">
                <p className="text-sm text-[#FA5300]">{order.reason}</p>
              </div>
            )}
            </motion.div>
            ))}
                  ...
                  {dateRangeOptions.map((option) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isSelected && <span className="text-xs font-semibold text-[#FA5300]">Selected</span>}
                      </button>
                    )
                  })}
                </div>
            ...
            >
                              ...
                              {isRadio ? (
                                <div
                                  ...
                                  className={`w-5 h-5 rounded-full border-2 cursor-pointer transition-all ${
                                    isChecked 
                                      ? 'border-[#FA5300] bg-white' 
                                      : 'border-gray-300 bg-white'
                                  }`}
                                >
                                  {isChecked && (
                                    <div className="w-full h-full rounded-full flex items-center justify-center">
                                      <div className="w-3 h-3 rounded-full bg-gradient-to-br from-[#FA5300] to-[#E54B00]"></div>
                                    </div>
                                  )}
                                </div>
                              ) : (
              ...
              <div className="flex items-center gap-3 px-4 py-3 border-t border-gray-200 bg-white">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2.5 bg-gradient-to-br from-[#FA5300] to-[#E54B00] rounded-lg text-sm font-medium text-white hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isApplyingFilters ? (
                    <>
      ...
      <AnimatePresence>
        {isApplyingFilters && !showFilterPopup && (
          ...
          >
            <div className="flex flex-col items-center gap-3">
              <svg className="animate-spin h-10 w-10 text-[#FA5300]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
              </svg>
      ...
      <AnimatePresence>
        {showToast && (
          <motion.div
            ...
            className="fixed bottom-24 left-1/2 -translate-x-1/2 z-60 bg-gradient-to-br from-[#FA5300] to-[#E54B00] text-white px-4 py-3 rounded-lg shadow-lg flex items-center gap-2"
          >
