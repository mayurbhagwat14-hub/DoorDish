      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        ...
        >
          <div className="w-20 h-20 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-6">
            <XCircle className="w-10 h-10 text-[#FA5300]" />
          </div>
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="bg-gradient-to-br from-[#FA5300] to-[#E54B00] text-white font-bold py-4 px-6 rounded-2xl transition-all active:scale-95 shadow-lg shadow-gray-200"
            >
              Try Again
            </button>
            <button
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full mx-4 text-center">
          <XCircle className="w-16 h-16 text-[#FA5300] mx-auto mb-4" />
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="px-4 py-4 space-y-4">
        ...
        <div className="bg-white rounded-lg p-4">
          ...
          {/* Rejection Reason */}
          {orderData.reason && (
            <p className="text-sm text-[#FA5300]">{orderData.reason}</p>
          )}
                  ...
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center gap-2">
                       <div className={`w-3 h-3 rounded-full border ${String(item.type).toLowerCase().includes("non") ? "border-red-600" : "border-green-600"} flex items-center justify-center p-[1px]`}>
                        <div className={`w-1.5 h-1.5 rounded-full ${String(item.type).toLowerCase().includes("non") ? "bg-gradient-to-br from-[#FA5300] to-[#E54B00]" : "bg-green-600"}`}></div>
                      </div>
                      <div>
      ...
      <AnimatePresence>
        {showToast && (
          <motion.div
            ...
            className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[60] bg-gradient-to-br from-[#FA5300] to-[#E54B00] text-white px-4 py-3 rounded-lg shadow-lg flex items-center gap-2 max-w-sm"
          >
            {isGeneratingPDF ? (
