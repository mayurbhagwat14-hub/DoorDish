    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        ...
        <div className="bg-blue-50 rounded-lg p-4 mb-6 flex items-start gap-4">
          <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#FA5300] to-[#E54B00] flex items-center justify-center shrink-0">
      ...
      <div className="px-4 pb-6 pt-4 bg-white border-t border-gray-200">
        <button
          ...
          className="w-full bg-gradient-to-br from-[#FA5300] to-[#E54B00] hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors"
        >
          Confirm
        </button>
      </div>
