    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
                  ...
                  <AnimatePresence>
                    ...
                    {showWarning && deliveryStatus && (
                      <motion.p 
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: -5 }}
                        className="text-xs text-[#FA5300] mt-2 animate-pulse flex items-center gap-1"
                      >
                        <AlertCircle className="w-3 h-3" />
                ...
                <div className="flex justify-center mb-4">
                  <div className={`w-16 h-16 rounded-full flex items-center justify-center ${
                    ...
                    <AlertCircle className={`w-10 h-10 ${
                      pendingStatus ? "text-orange-600" : "text-[#FA5300]"
                    }`} />
                  </div>
                </div>
                  ...
                  <button
                    ...
                    className={`flex-1 px-4 py-3 font-semibold rounded-lg transition-colors ${
                      pendingStatus 
                        ...
                        : "bg-gradient-to-br from-[#FA5300] to-[#E54B00] hover:bg-red-700 text-white"
                    }`}
                  >
      ...
      <AnimatePresence>
        {showSuccessToast && (
          ...
          >
            <div className="bg-gradient-to-br from-[#FA5300] to-[#E54B00] text-white px-4 py-3 rounded-lg shadow-2xl flex items-center gap-3">
