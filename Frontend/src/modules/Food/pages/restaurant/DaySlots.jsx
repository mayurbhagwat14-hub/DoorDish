    ...
    <div className="min-h-screen bg-white overflow-x-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">  
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="w-8 h-8 bg-pink-100 hover:bg-gradient-to-br from-[#FA5300] to-[#E54B00] rounded-full flex items-center justify-center transition-colors"
        ...
        {dayData.slots.length < 3 && (
          <button
            onClick={addSlot}
            className="w-full text-[#FA5300] hover:text-blue-700 text-sm font-medium py-3 transition-colors"
          >
            + Add time slot
          </button>
        )}
      ...
      <div className="sticky bottom-0 bg-white border-t border-gray-200 px-4 py-4 z-40 shadow-lg">
        <div className="space-y-4">
          ...
          <Button
            onClick={handleSave}
            className="w-full bg-gray-800 hover:bg-gradient-to-br from-[#FA5300] to-[#E54B00] text-white font-medium py-3 rounded-lg"
          >
            Save
          </Button>
        </div>
        ...
        <DialogContent className="sm:max-w-[425px] p-4">
          <DialogHeader>
            <div className="flex items-center gap-3 mb-2">
              <div className="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center shrink-0">
                <AlertTriangle className="w-6 h-6 text-[#FA5300]" />
              </div>
          ...
          <DialogFooter className="gap-2 sm:gap-0">
            ...
            <Button
              ...
              className="w-full sm:w-auto bg-gradient-to-br from-[#FA5300] to-[#E54B00] hover:bg-red-700 text-white"
            >
              Delete
            </Button>
          </DialogFooter>
