      ...
      <div className="w-full lg:w-1/2 h-full flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 sm:px-10 lg:px-16 pb-8">
          <Card className="w-full max-w-lg bg-white/80 backdrop-blur-sm border border-gray-200 shadow-xl">
            <CardHeader>
              <CardTitle className="text-2xl sm:text-[#FA5300]xl font-semibold text-gray-900">
            ...
            <CardContent className="space-y-5">
              ...
              {step === 1 && (
                <form onSubmit={handleFormSubmit} className="space-y-5">
                  ...
                  <Button
                    type="submit"
                    className="h-11 w-full bg-gradient-to-br from-[#FA5300] to-[#E54B00] hover:bg-gradient-to-br from-[#FA5300] to-[#E54B00]/90 text-white"
                    disabled={isLoading}
                  >
