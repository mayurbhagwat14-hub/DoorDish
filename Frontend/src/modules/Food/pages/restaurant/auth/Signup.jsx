    ...
    <div className="h-screen w-full flex bg-white overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        ...
        <div className="absolute inset-0 flex items-center text-white pointer-events-none">
          <div
            className="bg-gradient-to-br from-[#FA5300] to-[#E54B00]/80 rounded-r-full py-10 xl:py-20 pl-10 xl:pl-14 pr-10 xl:pr-20 max-w-[70%] shadow-xl backdrop-blur-[1px]"
      ...
      <div className="w-full lg:w-1/2 h-full flex flex-col">
        ...
        <div className="relative flex items-center justify-center px-6 sm:px-10 lg:px-16 pt-6 pb-4">
          ...
          >
            <div className="h-11 w-11 rounded-xl bg-gradient-to-br from-[#FA5300] to-[#E54B00] flex items-center justify-center text-white shadow-lg">
        ...
        >
          ...
          <div className="mb-8 text-center">
            <h2 className="text-2xl sm:text-[#FA5300]xl font-semibold text-gray-900 mb-2">
          ...
          >
            ...
            <div className="space-y-1.5">
              ...
              {errors.name && (
                <div className="flex items-center gap-1 text-xs sm:text-sm text-[#FA5300]">
            ...
            <div className="space-y-1.5">
              ...
              {apiError && !errors.phone && (
                <div className="flex items-center gap-1 text-xs sm:text-sm text-[#FA5300] mt-1">
                  <AlertCircle className="h-3 w-3" />
                  <span>{apiError}</span>
                </div>
              )}
            ...
            <Button
              type="submit"
              className="mt-2 h-11 w-full bg-gradient-to-br from-[#FA5300] to-[#E54B00] hover:bg-gradient-to-br from-[#FA5300] to-[#E54B00]/90 text-white text-base font-semibold rounded-md shadow-md transition-colors"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
