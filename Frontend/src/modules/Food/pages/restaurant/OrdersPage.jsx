  ...
  return (
    <div className="min-h-screen bg-[#f6e9dc] overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 pb-24 md:pb-6">
        {/* Title */}
        <h1 className="text-2xl md:text-[#FA5300]xl font-bold text-gray-800 mb-6 text-center md:text-left">
          Orders
        </h1>
        ...
        <div className="space-y-3 md:space-y-4">
          {showOrdersSkeleton ? (
            ...
            <div className="text-center py-12">
              <p className="text-[#FA5300] text-base md:text-lg mb-2">Error: {error}</p>
              <button 
                onClick={() => window.location.reload()} 
                className="text-[#FA5300] hover:underline"
              >
                Retry
              </button>
            </div>
              ...
              >
                <CardContent className="p-3 md:p-5 py-0 gap-0">
                  ...
                  <div className="flex items-center justify-between pt-2 md:pt-3 border-t border-gray-100 pb-3 md:pb-0">
                    <span className="text-[#FA5300] text-xs md:text-sm font-medium">
                      {order.deliveryType}
                    </span>
