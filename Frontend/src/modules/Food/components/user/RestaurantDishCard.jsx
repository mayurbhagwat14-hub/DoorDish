...
const RestaurantDishCard = ({ 
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        <h3 className="text-lg font-black text-gray-900 dark:text-gray-100 mb-1 line-clamp-1 group-hover:text-[#FF5A1F] transition-colors">
          {restaurant.name}
        </h3>
          ...
          <div className="mt-4 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-800/50 group/dish relative">
            <div className="flex justify-between items-center">
              <div className="flex-1">
                <span className="text-[10px] uppercase font-black text-[#FF5A1F] tracking-widest mb-1 block">Featured Dish</span>
              ...
              <button
                ...
                className="p-2 bg-white dark:bg-gray-700 rounded-xl shadow-sm hover:shadow-md hover:scale-110 transition-all text-[#FF5A1F] active:scale-95"
              >
