          ...
          {showSwitchOffPopup && (
            <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
              ...
              <motion.div
                ...
                animate={{ scale: 1, opacity: 1, y: 0 }}
                exit={{ scale: 0.9, opacity: 0, y: 20 }}
                className="relative bg-white dark:bg-[#1a1a1a] rounded-3xl p-6 sm:p-8 max-w-sm w-full shadow-2xl overflow-hidden border border-[#FF5A1F]/10 dark:border-[#FF5A1F]/30"
              >
                <div className="absolute -top-10 -right-10 w-32 h-32 bg-[#FF5A1F]/10 rounded-full blur-3xl" />

                <div className="relative text-center">
                  <div className="w-20 h-20 bg-[#FF5A1F]/5 dark:bg-[#FF5A1F]/20 rounded-full flex items-center justify-center mx-auto mb-6 ring-8 ring-[#FF5A1F]/5 dark:ring-[#FF5A1F]/5">
                    <AlertCircle className="w-10 h-10 text-[#FF5A1F] dark:text-[#FEE2E2]" />
                  </div>
                  ...
                  <div className="flex flex-col gap-3">
                    <button
                      ...
                      className="w-full py-4 bg-[#FF5A1F] hover:bg-[#E64A0F] text-white font-bold rounded-2xl shadow-lg shadow-[#FF5A1F]/25 transition-all duration-300 transform active:scale-95 flex items-center justify-center gap-2"
                    >
