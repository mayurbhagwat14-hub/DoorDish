            ...
            <div className="p-4 sm:p-6 overflow-y-auto max-h-[calc(85vh-120px)] custom-scrollbar">
              <div className="relative mb-8">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border-none focus:ring-2 focus:ring-[#FF5A1F]/20 text-sm font-medium transition-all"
                />
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-6">
                {filteredCategories.map((category, index) => (
                  ...
                  >
                    <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-white dark:bg-gray-800 shadow-sm group-hover:shadow-xl transition-all duration-300 p-0.5 ring-2 ring-transparent group-hover:ring-[#FF5A1F]/20 overflow-hidden transform group-hover:scale-105">
                      <OptimizedImage
                        src={category.image}
                        alt={category.name}
                    ...
                    <span className="text-xs sm:text-sm font-bold text-gray-700 dark:text-gray-300 group-hover:text-[#FF5A1F] text-center px-2 line-clamp-1">
                      {category.name}
                    </span>
                  </motion.div>
                ))}
