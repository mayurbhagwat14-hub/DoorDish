    ...
    <div className="relative w-full h-full overflow-hidden rounded-2xl shadow-inner border border-gray-100">
        ...
        {normRestCoords && (
          <OverlayView position={normRestCoords} mapPaneName={OverlayView.MARKER_LAYER}>
            <div className="relative -translate-x-1/2 -translate-y-full mb-1 group">
              {!isOrderPickedUp && (
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                  <motion.div
                    ...
                    className="w-16 h-16 rounded-full border-4 border-[#FF5A1F]/50"
                  />
                </div>
              )}
              <div className="relative w-11 h-11 rounded-full p-1 bg-white shadow-xl border-2 border-[#FF5A1F] overflow-hidden group-hover:scale-110 transition-transform">
                <img
              ...
              <div className="absolute top-[100%] left-1/2 -translate-x-1/2 w-3 h-3 bg-[#FF5A1F] -mt-1 shadow-sm" style={{ clipPath: 'polygon(50% 100%, 0 0, 100% 0)' }} />
            </div>
          </OverlayView>
        )}
      ...
      <AnimatePresence>
        {riderLocation && currentEta && !isTakeaway && (
          ...
          >
            <div className="bg-[#FF5A1F]/95 backdrop-blur-xl rounded-2xl p-3 shadow-[0_10px_30px_rgba(249,115,22,0.4)] border border-orange-400/50 flex flex-col min-w-[90px] group overflow-hidden relative">
