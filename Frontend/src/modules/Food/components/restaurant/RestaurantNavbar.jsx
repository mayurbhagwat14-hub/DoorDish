    ...
    <>
        ...
        <div className="px-4 py-3 bg-white">
          <div className="relative group">
            <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none">
              <Search className="h-4.5 w-4.5 text-slate-400 group-focus-within:text-[#FF5A1F] transition-colors" />
            </div>
            <input
              type="text"
              value={searchValue}
              ...
              className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-100 rounded-2xl text-[14px] font-semibold text-slate-900 placeholder:text-slate-400 placeholder:font-medium focus:outline-none focus:ring-2 focus:ring-[#FF5A1F]/10 focus:border-[#FF5A1F]/20 transition-all shadow-sm"
            />
            {searchValue && (
              <button
      ...
      {DINING_ENABLED && newReservation && (
        <div className="fixed top-20 left-4 right-4 z-[100] animate-in slide-in-from-top duration-300">
          <div className="bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-[#FF5A1F]/10 overflow-hidden">
            <div className="p-4 flex items-center gap-4">
              <div className="w-12 h-12 rounded-2xl bg-red-50 flex items-center justify-center shrink-0">
                <Utensils className="w-6 h-6 text-[#FF5A1F]" />
              </div>
