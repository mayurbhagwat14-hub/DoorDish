      ...
      <div className="flex items-center justify-around py-2 px-4">
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant") ? "text-[#FA5300]" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant/orders") ? "text-[#FA5300]" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 -mt-8 transition-colors ${
            isActive("/food/restaurant/explore") ? "text-[#FA5300]" : "text-gray-600"
          }`}
        >
          <div
            className={`rounded-full p-3 shadow-lg border-2 transition-colors ${
              isActive("/food/restaurant/explore")
                ? "bg-gradient-to-br from-[#FA5300] to-[#E54B00] border-white"
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant/wallet") ? "text-[#FA5300]" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant/food/all") ? "text-[#FA5300]" : "text-gray-600"
          }`}
        >
