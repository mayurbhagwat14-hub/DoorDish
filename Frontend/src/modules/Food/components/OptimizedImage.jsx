    ...
    <div className={`relative overflow-hidden ${className}`} ref={imgRef}>
      ...
      <picture className="absolute inset-0 w-full h-full">
        ...
        <img
          ...
          alt={alt || 'Food item'}
          className={`w-full h-full ${objectFit === 'cover' ? 'object-cover' : objectFit === 'contain' ? 'object-contain' : ''} ${priority || isLoaded || isFallback ? 'opacity-100' : 'opacity-0'} transition-opacity duration-300`}
