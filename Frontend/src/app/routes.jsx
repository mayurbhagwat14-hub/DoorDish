...
const FoodAdminRedirect = () => {
  const location = useLocation();
  const targetPath = location.pathname.replace(/^\/food\/admin/, '/admin') || '/admin';
    ...
    <Suspense fallback={<AppShellSkeleton />}>
      <MaintenanceGate>
        <Routes>
          ...
          {/* Food Admin Redirect - Redirect /food/admin/* to /admin/* */}
          <Route path="/food/admin/*" element={<FoodAdminRedirect />} />
